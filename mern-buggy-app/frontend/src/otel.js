...
const initializeOTel = () => {
    try {
        ...
        console.info("Frontend OpenTelemetry logging initialized successfully");
    } catch (error) {
        console.warn("OpenTelemetry initialization failed, logging will not be exported:", error);
    }
};
